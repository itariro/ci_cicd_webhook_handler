const resource_register = [
  ...
  },
  {
    ...
    read_filter:
      "id, name, mobile_number, farm, status, balance, auth_token, auth_token_expiry, deleted, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    table: "user_admin",
    schema:
    ...
    read_filter:
      "id, name, email_address, mobile_number, user_type, password, status, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    table: "user_partner",
    schema:
    ...
    read_filter:
      "id, name, email_address, partner_type, password, status, auth_token, auth_token_expiry, deleted, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    table: "field",
    schema:
    ...
    read_filter:
      "id, farmer_id, name, size, polygon, centre, deleted, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    ...
    read_filter:
      "id, field_id, summary, insight_request_date, insight_request_payload, insight_source, insight_response, deleted, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    ...
    read_filter:
      "id, mobile_user_id, description, date, direction, amount, new_balance, deleted, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    ...
    read_filter:
      "id, partner_id, description, date, direction, amount, new_balance, deleted, date_created DEFAULT CURRENT_TIMESTAMP, date_updated",
  },
  {
    table: "subscription",
    schema:
